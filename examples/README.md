...
| QtQuick          | `sudo apt install qml-module-qtquick`          |
| QtQuick.Controls | `sudo apt install qml-module-qtquick-controls` |
| QtQuick.Layouts  | `sudo apt install qml-module-qtquick-layouts`  |
| QtQuick.Window   | `sudo apt install qml-module-qtquick-window`   |
...
```
sudo apt install qmlscene qml-module-qtmultimedia qml-module-qtquick qml-module-qtquick-controls qml-module-qtquick-layouts qml-module-qtquick-window ros-jazzy-turtle-tf2-py
```
...
If you get "Could not find compatible format for video surface.", you most likely used yuyv which currently is not
supported as the compression in ROS does not work correctly.
